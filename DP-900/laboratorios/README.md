# Proyecto Formativo DP-900: Microsoft Azure Data Fundamentals

Bienvenido al repositorio oficial de estudio y preparación para la certificación **DP-900: Microsoft Azure Data Fundamentals**. 

Este repositorio centraliza todo el material teórico y práctico necesario para comprender los conceptos básicos de los datos y cómo se implementan utilizando los servicios de datos de Microsoft Azure. 

## 📖 Índice de Contenidos

Todos los materiales han sido estructurados modularmente para facilitar la lectura, el seguimiento y la integración con herramientas como GitHub, Docsify o GitBook.
...
El proyecto sigue una convención estricta de carpetas para garantizar que todos los enlaces relativos e imágenes funcionen a la perfección:

- Cada módulo teórico o laboratorio tiene **su propia carpeta**.
- Cada carpeta principal contiene un **único archivo `.md`** con el contenido.
- Las imágenes de cada documento se almacenan de forma local en la subcarpeta `imagenes/` de su respectivo directorio.
...
📝 **[Leer la GUÍA DE ESTILO completa](GUIA_DE_ESTILO.md)**
